            ...
            <el-col :span="12">
              <el-form-item label="表单类型" prop="formType">
                <hd-dict-select
                  ...
                  :model-text.sync="formData.formTypeValue"
            ...
            <el-col :span="12">
              <el-form-item label="所属机构" prop="orgId">
                <hd-organ
                  ...
                  :model-text.sync="formData.orgMc"
                  placeholder="请选择所属机构"
                  underline
                ></hd-organ>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="父级字典" prop="parentDicKey">
                <hd-dict-select
                  ...
                  :model-text.sync="formData.parentDicValue"
            ...
            <el-col :span="12">
              <el-form-item label="查询条件过滤类型" prop="etlType" label-width="160px">
                <hd-dict-select
                  ...
                  :model-text.sync="formData.etlTypeMc"
...
import { editForm, getFormDetail } from './api';
