<template>
  <el-dialog title="编辑任务对象" :visible.sync="visible" custom-class="hdty-dialog-medium" append-to-body>
...
import { formObjectEdit,formObjectDetail } from './api';
...
export default {
  ...
  data() {
    return {
      // 表单
      config:  {
        "id":"ssyhsfzhm","prop":"ssyhsfzhm","propText":"ssyhsfzhmText","propText":"ssyhsfzhmText","placeholder":"请选择责任人","label":"责任人","type":"personSelect","disabled":false,"typeId":"002","rules":{"required":false,"requiredMsg":"责任人不能为空"},"vIf":[{"label":"frmz","value":["0"]}],"valueField":"vo.gmsfhm"},
      // 表单
      formData: {
        name: '',
        tableKey: '',
