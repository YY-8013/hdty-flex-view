              ...
              <el-card class="con-card box-card" style="padding-bottom: 0">
                ...
                <div class="body" v-show="showRwyq">
                  <div class="form">
                      ...
                      <div class="form-item-12 form-item">
                        ...
                        <div class="p-div">
                          <el-tag
                            ...
                            effect="dark"
                            v-if="
                              formData.vo.taskState === '1' ||
                              formData.vo.taskState === '2'
                            "
                            >{{ formData.vox.taskState }}</el-tag
                          >
                          <el-tag
                            size="mini"
                            type="warning"
                            effect="dark"
                            v-if="formData.vo.taskState === '3'"
                            >{{ formData.vox.taskState }}</el-tag
                          >
                          <el-tag
                            size="mini"
                    ...
                    <!--任务办结时间-->
                    <div
                      v-show="formData.vo.taskState === '4'"
                      class="form-row"
                    >
                      <div class="form-item-24 form-item">
                        <label class="label">
...
export default {
  ...
  methods: {
    ...
    loadForm() {
      ...
      _this.currentTaskId = _this.row.vo.taskUserRecodeId;
      // Lambda写法
      ...
      getFormDetail(dataParams)
        .then((response) => {
          ...
          if (success) {
            ...
            // 表单加载完，加载表单对应的数据
            if (_this.formData.vo.taskState === "4") {
