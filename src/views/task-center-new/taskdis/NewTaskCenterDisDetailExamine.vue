    ...
    <div class="con-form-anchor">
      <div class="con-anchor">
        <div class="inner">
          ...
          <div
            class="anchor-item"
            :class="{ 'is-active': activeAnchor === 'anchorId55' }"
          >
            <a href="javascript:;" @click.prevent="handleAnchor('anchorId55')">
              <i class="el-icon-document"></i>
              <p>审批信息</p>
            </a>
          </div>
      ...
      <div class="con-form">
        <hd-pane fit v-loading="loading" id="scrollBox">
                  ...
                  <div class="form">
                    ...
                    <div class="form-row">
                      <div class="form-item-24 form-item">
                        ...
                        <div class="p-div p-divs">
                          <div class="text-div">{{ formData.vox.jzSsbm }}</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <!-- 流转轨迹-->
          <div class="con-area" id="gjInfo" v-if="!isSp">
            <div class="area-head">
              <div class="head">
                <i class="el-icon-s-operation"></i>
                流转轨迹
          ...
          <!--分析模型流程图-->
          <div class="con-area" id="anchorId43" v-if="!isSp">
            <div class="area-head">
              <div class="head">
                <i class="el-icon-guide"></i>
                分析模型流程图
          ...
          <!--任务流转流程图-->
          <div class="con-area" id="anchorId46" v-if="!isSp">
            <div class="area-head">
              <div class="head">
                <i class="el-icon-thumb"></i>
                任务流转流程图
          ...
          <!-- 审批信息 -->
          <div class="con-area" id="anchorId55">
            <div class="area-head">
              <div class="head">
                <i class="el-icon-document"></i>
                审批信息
            ...
            <NewTaskCenterDisExamine
              ...
              v-show="isShowSp"
            />
            <div class="area-body" v-show="!isShowSp">
              <el-card class="con-card box-card" style="padding-bottom: 0">
                <div slot="header" class="clearfix">
                  <div class="base">
                    <i class="el-icon-document"></i>审批信息
                  </div>
                  <div class="con-head-right">
                    <a
                      href="javascript:;"
                ...
                <div class="body" v-show="showRwyq">
                  <div class="form">
                    ...
                    <div
                      class="form-row"
                      v-if="formData.vo.spzt == '2' || formData.vo.spzt == '3'"
                    >
                      <div class="form-item-12 form-item">
                        <label class="label">
                          <span>审批人</span>
                        ...
                        <div class="p-div p-divs">
                          <div class="text-div">{{ formData.vo.spr }}</div>
                        </div>
                      </div>
                      <div class="form-item-12 form-item">
                        <label class="label">
                        ...
                        <div class="p-div p-divs">
                          <div class="text-div">{{ formData.vox.spsj }}</div>
                        </div>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      <div class="form-item-24 form-item">
                        ...
                        <div class="p-div p-divs">
                          <div class="text-div">{{ formData.vox.spjg }}</div>
                        </div>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      <div class="form-item-24 form-item">
                        ...
                        <div class="p-div p-divs">
                          <div class="text-div">{{ formData.vo.spyj }}</div>
                        </div>
                      </div>
                    </div>
                  </div>
...
import NewTaskCenterDisExamine from "./NewTaskCenterDisExamine";
import { bizPageSp } from "../biz-popover-xfgj/api";
