<template>
  <el-dialog title="删除" :visible.sync="visible" custom-class="new-form" append-to-body>
...
export default {
  name: 'NewTaskCenterDisDelete',
  provide() {
    return {
      NewTaskCenterDisDelete: this
    };
  },
  inject: ['hdList'],
