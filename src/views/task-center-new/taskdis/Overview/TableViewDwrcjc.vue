      ...
      >
        <hd-expand>
          <hd-expand-header ref="expandHeaderRef">
            ...
            <el-form-item class="con-cjsj" label="推送时间" prop="createTime">
              <el-date-picker
...
import { taskStatDwrcjc } from '../../api';
import FileSaver from 'file-saver';
import XLSX from 'xlsx';

export default {
  name: 'TableViewDwrcjc',
  components: { TableViewList, TableColumnCheck },
  provide() {
    return {
      hdList: this
    };
  ...
  methods: {
    ...
    handleExport() {
      ...
      // 获取业务类型
      function getBusType() {
        let res = ['#tableViewDwrcjc', '日常检查情况统计'];
        return res;
      }
