  ...
  <div class="hdty-container hdty-flex">
    ...
    <div class="hdty-fit">
      <el-table
        ...
        height="100%"
      >
        <el-table-column fixed prop="orgName" label="机构" header-align="center" min-width="220">
...
export default {
  ...
  methods: {
    ...
    /**
     *  二级列表
     *  isDtCol：是否是动态列，动态列传递时间为pushTime，否则传本年第一天开始时间到昨天结束
     * */
    handleSecondStat(stateList, row, yqType, zxbs, isDtCol) {
      // 本年第一天开始到昨天结束
      let startDate, endDate;
      const now = new Date();
      startDate = new Date(now.getFullYear(), 0, 1);
      ...
      this.$refs.taskPageRef.queryData.queryType =
        this.queryData.orgId === row.orgId ? '1' : '';
      ...
      this.$refs.taskPageRef.queryData.pushTime = isDtCol
        ? this.queryData.pushTime
        : arrTime;
