<template>
  <el-dialog title="撤回" :visible.sync="visible" custom-class="new-form" append-to-body>
    ...
    submitForm() {
      ...
      _this.$refs.formRef.validate((valid) => {
        if (valid) {
          ...
          // Lambda写法
          revokeTask(dataParams).then((response) => {
            //响应成功回调
