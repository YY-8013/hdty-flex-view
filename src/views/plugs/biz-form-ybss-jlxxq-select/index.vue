<template>
  <div>
    ...
    >
          ...
          <div class="hdty-header">
            ...
            >
              <el-form-item label="街路巷(小区)名称" prop="jlxxqmc">
                <el-input v-model="queryData.jlxxqmc" placeholder="请输入街路巷(小区)名称"></el-input>
              </el-form-item>
            ...
            >
              ...
              <el-table-column fixed label="操作" align="center" width="100">
                <template slot-scope="scope">
                  <el-button
                    v-if="currentValue === scope.row.vo.dzbm"
                    type="warning"
      ...
      <span slot="footer">
        <div class="hdty-flex-between" style="width:100%;">
          <span class="selected">
            <span>当前选择：</span>
            <el-tag
              v-if="input"
  ...
  methods: {
    ...
    handleChecked(index, row) {
      ...
      if (this.resultType === 'id') {
        ...
        // 值为 name，显示为 name
        this.input = row.vo.jlxxqmcQc;
        this.$emit('input', row.vo.jlxxqmcQc); //触发 input 事件，并传入新值
        this.$emit('update:modelText', row.vo.jlxxqmcQc);
      }
