              ...
              <hd-component :model="factorData" ref="componentRef">
                <el-form-item label="表单名称" prop="formName">
                  <hd-factor-input
                    ...
                    :model-contorl.sync="factorData.formNameFilterFactor"
                    fuzzy="between"
                    placeholder="请输入表单名称"
                  ></hd-factor-input>
                </el-form-item>
                ...
                <el-form-item label="表单编码" prop="formCode">
                  <hd-factor-input
                    ...
                    fuzzy="between"
                    :model-control.sync="factorData.formCodeFilterFactor"
                    placeholder="请输入表单编码"
                  ></hd-factor-input>
                </el-form-item>
              </hd-component>
            ...
            >
              ...
              >
                <template slot-scope="scope">
                  <el-tag
                    :type="
                      scope.row.vo.formType === '0' ? 'success' : 'primary'
                    "
                    size="mini"
                  >
...
export default {
  ...
  methods: {
    ...
    handleChecked(index, row) {
      this.visible = false;
      this.input = row.vo.formName;
      this.$emit("input", row.vo.id); //触发 input 事件，并传入新值
      this.$emit("update:modelText", row.vo.formName);
