                ...
                <biz-form-item label="审批业务类型" :required="true" :span="24">
                  <el-form-item prop="spYwType">
                    <hd-dict-select
                      ...
                      :model-text.sync="extendData.spYwType"
                        ...
                        <biz-form-item label="审批机构" :required="true" :span="24">
                          ...
                          >
                            <hd-organ
                              ...
                              :filterCode="$utilPublic.getUserInfo().orgId.substring(0, 4) + '00000000'"
                              showLevel="5"
                            ></hd-organ>
                          </el-form-item>
                        </biz-form-item>
        ...
        .map((order) => {
          ...
          if (firstItem.spMode === '0') {
            ...
            return {
              ...
              spMatchLevelList: firstItem.spMatchLevelList,
              spMatchLevelTextList: firstItem.spMatchLevelTextList,
