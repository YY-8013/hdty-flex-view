      ...
      <el-form
        ...
        <hd-component
          ...
          <el-form-item label="所属企业" prop="companyName">
            <el-input v-model="fromData.companyName" placeholder="请输入系统所属企业"
                      maxlength="100" underline></el-input>
          </el-form-item>
          ...
          <el-form-item label="备  注" prop="memo">
            <el-input type="textarea"
                      :rows="3" v-model="fromData.memo" placeholder="请输入备注"
...
<script>
  ...
  import { edit, editBefore } from '@/api/joinsys-auth';

  export default {
    name: "JoinSysAuthEdit",
    provide() {
      return {
        hdEdit: this
      };
