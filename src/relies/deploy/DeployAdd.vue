<template>
  <el-dialog title="添加" :visible.sync="visible" custom-class="hdty-dialog-medium" append-to-body>
      ...
      >
        ...
        <div class="listContainer">
          ...
          <el-form-item label="分数配置">
            <el-row class="score-row" v-for="(item, index) in addData.scoreList" :key="index">
              <el-col :span="24">
                <el-col :span="22">
                  <el-col :span="12">
                    <el-form-item
                ...
                <el-col :span="2">
                  <el-col :span="24" class="score-fourth-col">
                    <el-button
                      ...
                      :disabled="addData.scoreList.length <= 1"
                    ></el-button>
                  </el-col>
                </el-col>
              </el-col>
        ...
        <div class="listContainer">
          ...
          <el-form-item label="附件配置">
            <el-row class="score-row" v-for="(item, index) in addData.docList" :key="index">
              <el-col :span="24">
                <el-col :span="22">
                  <el-col :span="12">
                ...
                <el-col :span="2">
                  <el-col :span="24" class="score-fourth-col">
                    <el-button
                      ...
                      :disabled="addData.docList.length <= 1"
                    ></el-button>
                  </el-col>
                </el-col>
              </el-col>
        ...
        <div class="listContainer">
          ...
          <el-form-item label="审批配置">
            <el-row class="score-row" v-for="(item, index) in addData.spList" :key="index">
              <el-col :span="24">
                <el-col :span="22">
                  <el-col :span="12">
                ...
                <el-col :span="2">
                  <el-col :span="24" class="score-fourth-col">
                    <el-button
                      ...
                      :disabled="addData.spList.length <= 1"
                    ></el-button>
                  </el-col>
                </el-col>
              </el-col>
...
export default {
  ...
  methods: {
    ...
    validateScore(rule, value, callback) {
      if (value) {
        ...
        if (!reg.test(value)) {
          ...
          let mun = 0;
          this.addData.scoreList.forEach((item) => {
    ...
    // 分数项新增
    handleScoreAdd() {
      if (this.addData.scoreList.length < 3) {
        this.addData.scoreList.push({ vo: {}, vox: {} });
      } else {
        this.$message({
          showClose: true,
    ...
    handleScoreDelete(index) {
      ...
      _this
        ...
        .then(() => {
          _this.addData.scoreList.splice(index, 1);
        });
    },
    // 附件新增项
    handleDocAdd() {
      this.addData.docList.push({ vo: {}, vox: {} });
    },
    // 附件项删除
    handleDocDelete(index) {
      ...
      _this
        ...
        .then(() => {
          _this.addData.docList.splice(index, 1);
        });
    },
    // 审批新增项
    handleApproveAdd() {
      this.addData.spList.push({ vo: {}, vox: {} });
    },
    // 审批项删除
    handleApproveDelete(index) {
      ...
      _this
        ...
        .then(() => {
          _this.addData.spList.splice(index, 1);
        });
    },
    // 格式化提交数据
    formatData() {
      ...
      // 管辖机构
      dataParams.orgid = this.addData.orgid;
      // 分数
      this.addData.scoreList.forEach((item) => {
        if (
          item.vo.score &&
      ...
      // 附件
      this.addData.docList.forEach((item) => {
        if (
          item.vo.ywlx &&
          item.vo.zdrylx &&
          item.vo.allDocs &&
      ...
      // 审批
      this.addData.spList.forEach((item) => {
        if (
          item.vo.ywlx &&
          item.vo.zdrylx &&
          item.vo.spLevel &&
    ...
    submitForm() {
      ...
      _this.$refs.formRef.validate((valid) => {
        if (valid) {
          ...
          _this.addData.scoreList.forEach((item) => {
            if (
              !item.vo.score &&
              !item.vo.levelCode &&
              !item.vo.gkplKey &&
          ...
          let docStatus = true;
          _this.addData.docList.forEach((item) => {
            if (
              !item.vo.ywlx &&
          ...
          let spStatus = true;
          _this.addData.spList.forEach((item) => {
            if (
              !item.vo.ywlx &&
              (!item.vo.zdrylx || item.vo.zdrylx.length === 0) &&
    ...
    handleAllChange(index) {
      this.addData.docList[index].vo.requiredDocs = [];
    },
    // 根据字典key获取字典value
    handleDocName(key) {
