<template>
  <div
    class="hdty-slide-verify slide-verify"
    id="slideVerify"
    ...
    <div
      ...
      :class="{ 'container-active': containerActive,
...
<script>
  import img0 from './src/images/img-001.jpg';
  import img1 from './src/images/img-002.jpg';
  import img2 from './src/images/img-003.jpg';
  import img3 from './src/images/img-004.jpg';
  import img4 from './src/images/img-005.jpg';
      ...
      getRandomImg() {
        ...
        return len > 0 ?
          ...
          [
            ...
            img3,
            img4
          ][this.getRandomNumberByRange(0, 4)];
      },
...
<style scoped>
  ...
  .slide-verify-refresh-icon {
    ...
    height: 34px;
    cursor: pointer;
    background: url('./src/images/icon_light.png') 0 -437px;
  ...
  .slide-verify-slider-mask-item-icon {
    ...
    width: 14px;
    height: 12px;
    background: url('./src/images/icon_light.png') 0 -26px;
    background-size: 34px 471px;
  }
