...
<script>
  export default {
    ...
    computed: {
      ...
      expandButtonSize() {
        return this.expand.expandButtonSize;
      }
    },
    mounted() {
      this.showExpandButton = !!this.expandBody;
    },
    methods: {
      // 打开更多筛选
      handleMore() {
        this.opened = !this.opened;
        this.expandBody.opened = this.opened;
        if(this.expandBody.$refs.expandDrawerRef) {
          if(!this.expandBody.$refs.expandDrawerRef.rendered) {
